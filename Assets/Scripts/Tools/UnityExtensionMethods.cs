...
namespace Game.Scripts.Tools
{
	public static class UnityExtensionMethods
	{
		...
		public static T Copy<T>(this T source, Transform parent = null, string name = "", bool activate = true) where T : Component
		{
		...
		public static GameObject Copy(this GameObject source, Transform parent = null, string name = "", bool activate = true)
		{
			if (source == null)
			{
				Debug.LogError("Null prefab");
